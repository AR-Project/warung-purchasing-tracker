...
export default function UpdatePurchaseItemDataForm({
  ...
  return (
    <form action={formAction}>
      ...
      <Button
        type="submit"
        className="inline-flex items-center gap-2 rounded-sm bg-blue-700 py-1.5 px-3 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 data-[hover]:bg-red-500 data-[focus]:outline-1 data-[focus]:outline-white data-[open]:bg-gray-700"
      >
        {isPending ? (
          <>Sedang diproses... </>
        ) : (
